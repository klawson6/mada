...
<div id = "sign_up">
    <form method="post" id="sign_up_form" class="form-horizontal" action="Index.php?action=logIn">
        ...
        <input type="submit" style="color: rgb(31, 39, 52)" class="btn btn-lg btn-inverse btn-block" id="numberSubmit" value="Request SMS Code">
    </form>
    ...
    <form method="post" id="sendCode" class="form-horizontal" action="Index.php?action=logIn">
        ...
        <input type="submit" style="color: rgb(31, 39, 52)" class="btn btn-lg btn-inverse btn-block" id="codeSubmit" value="Request SMS Code">
    </form>
    </div>
</div>
</body>
